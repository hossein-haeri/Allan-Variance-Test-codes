...
fig1 = figure('Position', [10 10 700 200]);
    hold on
...
%     xline(t_range/2+tau(idx)/2,'LineStyle','--','LineWidth',2,'Color',[.3 .3 .3]);
    ...
    grid on
    legend('Measurements','Actual','MSE Estimate','AVAR Estimate','Location','north','Orientation','horizontal')

fig2 = figure('Position', [400 10 700 300]);
    subplot(2,1,1)
        hold on
